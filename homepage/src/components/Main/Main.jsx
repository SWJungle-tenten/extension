  ...
  return (
    <>
      <div className="flex p-10 space-x-2 justify-between bg-orange-400">
        ...
        <button onClick={logout} className="bg-white text-orange-400 hover:bg-oragne-700 focus:ring-4 focus:outline-none focus:ring-orange-300 font-semibold rounded-lg text-sm px-5 py-2 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">로그아웃</button>
      </div>
